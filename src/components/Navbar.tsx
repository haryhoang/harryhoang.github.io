  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#1a1a1a] text-white py-3 px-6 flex items-center justify-between shadow-md">
      <div className="flex items-center gap-3">
        <div className="bg-[#8c1515] p-1.5 rounded-sm">
          <img 
        ...
        <div className="bg-[#333] px-3 py-1 rounded border border-white/10">
          <span className="font-bold text-sm">Harry Hoang</span>
        </div>
      </div>

      <div className="hidden md:flex items-center gap-8 text-sm font-medium opacity-90">
        <a href="#lecture-notes" className="hover:text-white transition-colors">Lecture notes</a>
      </div>

      <div className="flex items-center gap-3">
        <span className="text-sm font-medium hidden sm:inline">Harry Hoang</span>
        <img 
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQf2eggVL9PXsqLGieoXyBD-fROPc1_6RBNEw&s" 
          alt="MIT Logo" 
          className="w-8 h-4 invert opacity-80"
          referrerPolicy="no-referrer"
        />
      </div>
    </nav>
